...
public class FinalSimulation extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        controlSection.setPrefWidth(screenWidth*0.3);
        controlSection.setPrefHeight(screenHeight*0.2);
    ...
    private Label instructionLabel(){
        ...
        instruction_label.setStyle("-fx-border-color: black; " +
                ...
                "-fx-padding: 5px;"+
                "-fx-background-color: rgb(252,242,242);");
        Font customFont = new Font("", Screen.getPrimary().getBounds().getHeight()*0.02);
    ...
    private Label createLogLabels(){
        ...
        loglabel.setStyle("-fx-border-color: black; " +
                ...
                "-fx-background-color: rgb(252,242,242);"+
                "-fx-font-weight: BOLD");
        Font customFont = new Font("", Screen.getPrimary().getBounds().getHeight()*0.015); // Set your desired font family and size
...
//        return (10+ new Random().nextDouble() * (20 - 10));
        return (35+ new Random().nextDouble() * (100 - 35));
    }
